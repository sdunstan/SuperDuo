...
public class Utilies
{
    ...
    public static String getLeague(Context ctx, int league_num)
    {
        switch (league_num)
        {
            case SERIE_A : return  ctx.getString(R.string.league_seria_a);
            case PREMIER_LEGAUE : return ctx.getString(R.string.league_premier_league);
            case CHAMPIONS_LEAGUE : return ctx.getString(R.string.league_champions_league);
            case PRIMERA_DIVISION : return ctx.getString(R.string.league_premera_division);
